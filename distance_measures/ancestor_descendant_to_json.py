...
import json
import ancestor_descendant as ad
...
def ad_main(filename_1, filename_2):
    ...
    dict_1, dict_2 = ad.get_contributions(g_1,g_2)
    nx.set_node_attributes(g_1,dict_1)
    nx.set_node_attributes(g_2,dict_2)
    data_1 = json_graph.tree_data(g_1, root=ad.get_root(g_1))
    data_2 = json_graph.tree_data(g_2, root=ad.get_root(g_2))
...
if __name__=="__main__":
    ...
    print(s_1)
    print(s_2)
    ad.ancestor_descendant(g_1, g_2)